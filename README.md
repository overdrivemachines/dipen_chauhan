...
2) IP Address Info
  - Display IP address
  - Display Web browswer information

3) Legal paper writer
  - Generate legal documents based on user input
  - Save and print documents

4) Multi-select dropdown
  - https://codyhouse.co/ds/components/info/multiple-custom-select
  - https://demo.mobiscroll.com/javascript/select/multiple-select
  ...
  - The customizable select:
    -  Part 1: history, trickery, and styling the select with CSS: https://utilitybend.com/blog/the-customizable-select-part-one-history-trickery-and-styling-the-select-with-css
    - Part 2: Potions, anchoring, and radial shenanigans in CSS: https://utilitybend.com/blog/the-customizable-select-part-two-potions-anchoring-and-radial-shenanigans-in-css
    - Part 3: Sticky Options: https://utilitybend.com/blog/the-customizable-select-part-three-sticky-options
    - Part 4: Scroll snapping, state queries, monster hunter, and gamification: https://utilitybend.com/blog/the-customizable-select-part-four-scroll-snapping-state-queries-monster-hunter-and-gamification
    - Part 5: Optgroup, creating a true select menu: https://utilitybend.com/blog/the-customizable-select-part-five-optgroup-creating-a-true-select-menu
  
5) Stocks List using AI

6) Case Narrative

7) Clipboard over SSH
